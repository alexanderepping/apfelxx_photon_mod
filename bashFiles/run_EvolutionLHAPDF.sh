...
echo ""
echo "Running the EvolutionLHAPDF.cc program!"
echo ""
...
# Deleting previous EvolutionLHAPDF program
make clean > $voidOutput

# Making new EvolutionLHAPDF program
make EvolutionLHAPDF > $voidOutput

# Running EvolutionLHAPDF program
./EvolutionLHAPDF
