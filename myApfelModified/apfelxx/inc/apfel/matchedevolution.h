...
namespace apfel
{
  ...
  public:
     ...
     * @return the object evolved at the scale mu2
     */
    virtual T EvolveObject(int const& nf, double const& mu02, double const& mu2, T const& Obj0, int const& pto, std::function<double(double const&)> const& Alphas) const;
     ...
     * @return the evolved object.
     */
    T Evaluate(double const& mu, int const& pto, std::function<double(double const&)> const& Alphas) const;
