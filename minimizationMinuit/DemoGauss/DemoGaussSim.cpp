 ...
 *                                                                    *
 **********************************************************************/
//g++ -std=c++17 -I/home/alexander/Uni/apfelxx_photon_mod/myApfelModified/include -I/home/alexander/Uni/apfelxx_photon_mod/myLHAPDFModified/include -o DemoGaussSim DemoGaussSim.cpp GaussFcn.cpp GaussFcn.h GaussFunction.h GaussDataGen.h GaussDataGen.cpp GaussRandomGen.h FlatRandomGen.h -L/home/alexander/Uni/apfelxx_photon_mod/myApfelModified/lib -lapfelxx -L/home/alexander/Uni/apfelxx_photon_mod/myLHAPDFModified/lib -lLHAPDF -L/home/alexander/Uni/minuit-cpp/build/lib/ -lminuit-cpp
...
#include "/usr/local/include/minuit-cpp/MnMinos.hh"
#include "/usr/local/include/minuit-cpp/MnContours.hh"
#include "/usr/local/include/minuit-cpp/MnPlot.hh"
#include "/usr/local/include/minuit-cpp/MinosError.hh"
#include "/usr/local/include/minuit-cpp/ContoursError.hh"

#include "/usr/local/include/minuit-cpp/MnHesse.hh"
#include "/usr/local/include/minuit-cpp/MnEigen.hh"

#include <iostream>

using namespace MinuitCpp;
...
/*
  ...
  */

  {
    ...
    MnEigen Eigen;
    std::vector<double> EigenValues = Eigen(min.UserCovariance()); // the Eigenvalues are calculated, ordered from smallest to largest

    // min ist die error matrix
    std::cout<<"minimum: "<<min<<std::endl; //hier wird square roots of the diagonal elements ausgegeben als error
  }
/*
  {
