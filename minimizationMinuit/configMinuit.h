...
enum enumInitialPDFs { // InitialPDFs related to InitialPDFsMain0
                       ...
                       INITIALPDFS_SAL4,        // same as SAL5 w/out B_Q_PL, used by Vadim
...
const std::map<int, double> DeltaChi2Map = {
        ...
        {INITIALPDFS_SAL4,             14.4173},
        {INITIALPDFS_SAL3,             51.5881}
#endif //LO

#ifdef HO
        {INITIALPDFS_SAL5,             8.65906},
        {INITIALPDFS_SAL4,             9.13941},
...
const std::map<int, std::vector<std::string>> initialParamsNames = {{INITIALPDFS_9GDUS,                 {"K_s1", "A_g1", "B_g1", "AN_d1", "A_d1", "B_d1", "AN_u1", "A_u1", "B_u1"}},
                                                                    ...
                                                                    {INITIALPDFS_SAL4,                  {"B_G_HAD", "A_Q_HAD", "B_Q_HAD", "A_Q_PL"}},
