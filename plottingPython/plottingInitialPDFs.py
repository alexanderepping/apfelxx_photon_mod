...
def InitialPDFdownSAL(x, A_had, B_had, C_had, A_pl, B_pl):
    return A_had * x**B_had * (1-x)**C_had + 1/9 * A_pl * (x**2 + (1-x)**2)/(1-B_pl*np.log(1-x))

def InitialPDFupSAL(x, A_had, B_had, C_had, A_pl, B_pl):
    return A_had * x**B_had * (1-x)**C_had + 4/9 * A_pl * (x**2 + (1-x)**2)/(1-B_pl*np.log(1-x))

def InitialPDFstrangeSAL(x, K, A_had, B_had, C_had, A_pl, B_pl):
    return K * A_had * x**B_had * (1-x)**C_had + 1/9 * A_pl * (x**2 + (1-x)**2)/(1-B_pl*np.log(1-x))
