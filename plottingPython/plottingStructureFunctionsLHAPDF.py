...
input_file = "dataStructureFunctions.txt"
...
# save figure options
save_fig = False
pltname = "plotStructureFunctions"
dpi=200 
...
if len(mu_vals) == 1:
    fig, axs = plt.subplots(1, 1, sharex=True, figsize=(12*scale,7*scale))
    subplt = [axs[0]]
elif len(mu_vals) == 2:
    fig, axs = plt.subplots(2, 1, sharex=True, figsize=(12*scale,7*scale))
    subplt = [axs[0], axs[1]] 
elif len(mu_vals) == 3:
    fig, axs = plt.subplots(3, 1, sharex=True, figsize=(12*scale,7*scale))
