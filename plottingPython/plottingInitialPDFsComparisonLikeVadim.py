...
if True:
    # plot gluon
    subplt[0].plot(x_GRV[0], GRV_values[0], label=GRV_label, linestyle="-.", color="blue")
    ...
    # plot down quark
    subplt[2].plot(x_GRV[1], GRV_values[1], label=GRV_label, linestyle="-.", color="blue")
    ...
    # plot up quark
    subplt[3].plot(x_GRV[2], GRV_values[2], label=GRV_label, linestyle="-.", color="blue")
    ...
    # plot strange quark
    subplt[1].plot(x_GRV[3], GRV_values[3], label=GRV_label, linestyle="-.", color="blue")
