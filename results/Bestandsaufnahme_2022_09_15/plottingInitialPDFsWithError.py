...
c = 1.75
showSALInitialPDFs = False

# save figure options
save_fig = True
pltdir = "/home/alexander/Uni/apfelxx_photon_mod/results/Bestandsaufnahme_2022_09_15/" 
pltname = pltdir + "plotInitialPdfsErrors_SAL5HO"
...
if (InitialPDFsType == "0"):
    ...
    if not ratioError:
        ...
        if ErrorPDFs:
            subplt[0].fill_between(x, LowerErrorPDF(InitialPDFgluonSAL, x, Parameters, ErrorParametersPlus, ErrorParametersMinus), UpperErrorPDF(InitialPDFgluonSAL, x, Parameters, ErrorParametersPlus, ErrorParametersMinus), alpha=0.2)
    ...
    if not ratioError:
        ...
        if ErrorPDFs:
            subplt[2].fill_between(x, LowerErrorPDF(InitialPDFdownSAL, x, Parameters, ErrorParametersPlus, ErrorParametersMinus), UpperErrorPDF(InitialPDFdownSAL, x, Parameters, ErrorParametersPlus, ErrorParametersMinus), alpha=0.2)
    ...
    if not ratioError:
        ...
        if ErrorPDFs:
            subplt[3].fill_between(x, LowerErrorPDF(InitialPDFupSAL, x, Parameters, ErrorParametersPlus, ErrorParametersMinus), UpperErrorPDF(InitialPDFupSAL, x, Parameters, ErrorParametersPlus, ErrorParametersMinus), alpha=0.2)
    ...
    if not ratioError:
        ...
        if ErrorPDFs:
            subplt[1].fill_between(x, LowerErrorPDF(InitialPDFstrangeSAL, x, Parameters, ErrorParametersPlus, ErrorParametersMinus), UpperErrorPDF(InitialPDFstrangeSAL, x, Parameters, ErrorParametersPlus, ErrorParametersMinus), alpha=0.2)
